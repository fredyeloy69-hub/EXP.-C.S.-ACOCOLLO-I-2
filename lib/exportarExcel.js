...
export async function generarListaSeparadoresExcel(areaNombre, carpetasDelArea) {
  ...
  for (const item of items) {
    ...
    if (item.nivel === 1) {
      ...
      // Carpeta de nivel 2+ que a su vez contiene subcarpetas — sombreado
      // tenue del mismo color, cada vez más pálido mientras más profundo.
      ...
      // Ítem final (hoja, sin hijos): sin sombreado, columna de archivadores
      // en blanco/amarillo para completar a mano.
